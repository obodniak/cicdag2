[![Java CI with Maven](https://github.com/obodniak/cicdag2/actions/workflows/maven.yml/badge.svg?event=push)](https://github.com/obodniak/cicdag2/actions/workflows/maven.yml)
## Prerequisites:
